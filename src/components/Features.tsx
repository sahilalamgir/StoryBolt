      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Our AI-powered platform creates unique stories with matching
            illustrations, giving you a personalized experience unlike any
            other.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-12">
          <div className="flex items-start p-6 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Our state-of-the-art AI creates cohesive, engaging narratives
                tailored to your specific input and preferences.
              </p>
            </div>
          </div>
          <div className="flex items-start p-6 bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Each paragraph comes with a matching custom image, bringing your
                story to life with visually stunning scenes.
              </p>
            </div>
          </div>
          <div className="flex items-start p-6 bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <div>
              ...
              <p className="text-gray-600">
                From fantasy to sci-fi, children&apos;s stories to mysteries,
                our platform adapts to any genre or theme you desire.
              </p>
            </div>
          </div>
          <div className="flex items-start p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Get your complete story with images in seconds, not hours,
                letting your creativity flow without interruption.
              </p>
            </div>
          </div>
        </div>
